 ...
 */
#ifndef BX_FETCH_BLOCK_HEIGHT_HPP
#define BX_FETCH_BLOCK_HEIGHT_HPP
 ...
 */
#define BX_FETCH_BLOCK_HEIGHT_NOT_IMPLEMENTED \
    "This command is not yet implemented."

/**
 * Class to implement the fetch-block-height command.
 */
class BCX_API fetch_block_height
  : public command
{
public:
    ...
    {
        return "fetch-block-height";
    }

    /**
     * Destructor.
     */
    virtual ~fetch_block_height()
    {
    }
    ...
    {
        return fetch_block_height::symbol();
    }
    ...
    {
        return "Get the block height from the specified hash. Requires a Libbitcoin server connection.";
    }
