 ...
 */
#ifndef BX_GET_FILTER_CHECKPOINT_HPP
#define BX_GET_FILTER_CHECKPOINT_HPP
...
#define BX_GET_FILTER_CHECKPOINT_NOT_IMPLEMENTED \
    "This command is not yet implemented."

/**
 * Class to implement the get-filter-checkpoint command.
 */
class BCX_API get_filter_checkpoint
  : public command
{
public:
    ...
    {
        return get_filter_checkpoint::symbol();
    }
