 ...
 */
#ifndef BX_BASE32_ENCODE_HPP
#define BX_BASE32_ENCODE_HPP
...
/**
 * Class to implement the base32-encode command.
 */
class BCX_API base32_encode
  : public command
{
public:
    ...
    {
        return "Convert binary data to Base32.";
    }
    ...
    virtual system::options_metadata& load_options()
    {
        ...
        (
            ...
            "The binary data to encode as Base32. This can be text or any other data. If not specified the data is read from STDIN."
        );
