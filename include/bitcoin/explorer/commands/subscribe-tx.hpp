 ...
 */
#ifndef BX_SUBSCRIBE_TX_HPP
#define BX_SUBSCRIBE_TX_HPP
...
/**
 * Class to implement the subscribe-tx command.
 */
class BCX_API subscribe_tx
  : public command
{
public:
    ...
    {
        return "Watch the network for all transactions. Requires a Libbitcoin server connection.";
    }
