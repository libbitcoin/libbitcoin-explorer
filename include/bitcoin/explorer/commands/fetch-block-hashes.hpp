 ...
 */
#ifndef BX_FETCH_BLOCK_HASHES_HPP
#define BX_FETCH_BLOCK_HASHES_HPP
 ...
 */
class BCX_API fetch_block_hashes
  : public command
{
public:
    ...
    {
        return "fetch-block-hashes";
    }

    /**
     * Destructor.
     */
    virtual ~fetch_block_hashes()
    {
    }
    ...
    {
        return fetch_block_hashes::symbol();
    }
