...
public:
    ...
    {
        return "Get the block height and index of a transaction. Requires an Obelisk server connection.";
    }
    ...
    virtual options_metadata& load_options()
    {
        ...
        (
            ...
            "The set of Base16 transaction hashes. If not specified the transaction hashes are read from STDIN."
        );
