 ...
 */
#ifndef BX_CHECKED_ENCODE_HPP
#define BX_CHECKED_ENCODE_HPP
...
/**
 * Class to implement the checked-encode command.
 */
class BCX_API checked_encode
  : public command
{
public:
    ...
    {
        return "Add a version byte and bitcoin checksum to Base16 data.";
    }
    ...
    virtual system::options_metadata& load_options()
    {
        ...
        (
            ...
            "The Base16 data to encode. If not specified the value is read from STDIN."
        );
