...
public:
    ...
    {
        load_input(get_salt_argument(), "SALT", variables, input);
    }
    ...
    virtual options_metadata& load_options()
    {
        ...
        (
            "SALT",
            value<system::config::base16>(&argument_.salt),
     ...
     */
    virtual system::config::base16& get_salt_argument()
    {
