 ...
 */
#ifndef BX_EK_PUBLIC_TO_ADDRESS_HPP
#define BX_EK_PUBLIC_TO_ADDRESS_HPP
...
/**
 * Class to implement the ek-public-to-address command.
 */
class ek_public_to_address 
    : public command
{
public:
    ...
    {
        return ek_public_to_address::symbol();
    }
    ...
    {
        return "Extract the payment address of an encrypted public key (BIP38).";
    }
    ...
    BCX_API virtual options_metadata& load_options()
    {
        ...
        (
            ...
            "The passphrase that was used to generate the intermediate passphrase token."
        )
        (
            "EK_PUBLIC_KEY",
            value<primitives::ek_public>(&argument_.ek_public_key),
     ...
     */
    BCX_API virtual primitives::ek_public& get_ek_public_key_argument()
    {
    ...
    BCX_API virtual void set_ek_public_key_argument(
        const primitives::ek_public& value)
    {
...
private:
    ...
    struct argument
    {
        ...
        primitives::ek_public ek_public_key;
    } argument_;
