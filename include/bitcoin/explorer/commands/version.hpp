 ...
 */
#ifndef BX_VERSION_HPP
#define BX_VERSION_HPP
...
public:
    ...
    {
        return "Fetch and display the libbitcoin server and client versions. Requires a Libbitcoin server connection.";
    }
