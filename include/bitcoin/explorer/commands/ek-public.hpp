 ...
 */
#define BX_EK_PUBLIC_SHORT_ENTROPY \
...
public:
    ...
    virtual system::options_metadata& load_options()
    {
        ...
        (
            "TOKEN",
            value<system::wallet::ek_token>(&argument_.token)->required(),
        ...
        (
            ...
            "The Base16 entropy for the new encrypted public key. Must be at least 192 bits in length (only the first 192 bits are used). If not specified the entropy is read from STDIN."
        );
     ...
     */
    virtual system::wallet::ek_token& get_token_argument()
    {
    ...
    virtual void set_token_argument(
        const system::wallet::ek_token& value)
    {
