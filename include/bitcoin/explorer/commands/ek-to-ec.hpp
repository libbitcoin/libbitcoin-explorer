...
public:
    ...
    {
        load_input(get_ek_private_key_argument(), "EK_PRIVATE_KEY", variables, input);
    }
    ...
    virtual options_metadata& load_options()
    {
        ...
        (
            "EK_PRIVATE_KEY",
            value<system::wallet::ek_private>(&argument_.ek_private_key),
     ...
     */
    virtual system::wallet::ek_private& get_ek_private_key_argument()
    {
    ...
    virtual void set_ek_private_key_argument(
        const system::wallet::ek_private& value)
    {
...
private:
    ...
    struct argument
    {
        ...
        system::wallet::ek_private ek_private_key;
    } argument_;
