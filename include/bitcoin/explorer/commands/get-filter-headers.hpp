...
#define BX_GET_FILTER_HEADERS_NOT_IMPLEMENTED \
...
public:
    ...
    {
        return "Retrieve compact filter headers from a single Bitcoin network node. The distance between provided height and hash must be strictly less than 2000.";
    }
