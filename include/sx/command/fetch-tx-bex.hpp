 ...
 */
#ifndef SX_FETCH_TX_BEX_HPP
#define SX_FETCH_TX_BEX_HPP
 ...
 */
#define SX_FETCH_TX_BEX_NOT_IMPLEMENTED \
    "This command is not yet implemented."

/**
 * Class to implement the sx fetch-tx-bex command.
 */
class fetch_tx_bex 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "fetch-tx-bex"; }
    ...
    {
        load_path(get_hash_argument(), "HASH", variables);
