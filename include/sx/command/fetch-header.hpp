 ...
 */
#ifndef SX_FETCH_HEADER_HPP
#define SX_FETCH_HEADER_HPP
...
/**
 * Class to implement the sx fetch-header command.
 */
class fetch_header 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "fetch-header"; }
    ...
    virtual options_metadata& load_options()
    {
        ...
        options.add_options()
            ...
            (
                ...
                "Get the raw block header from the specified hash or height. Requires a server connection."
            )
            (
                "hash,s",
