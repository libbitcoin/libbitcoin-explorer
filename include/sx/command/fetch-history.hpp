 ...
 */
#ifndef SX_FETCH_HISTORY_HPP
#define SX_FETCH_HISTORY_HPP
 ...
 */
#define SX_FETCH_HISTORY_PENDING \
    "Pending"
#define SX_FETCH_HISTORY_UNSPENT \
    "Unspent"
#define SX_FETCH_HISTORY_OUTPUT \
    "Address: %1%\n  Output: %2%\n  Output height: %3%\n  Value: %4%\n  spend: %5%\n  Spend height: %6%"

/**
 * Class to implement the sx fetch-history command.
 */
class fetch_history 
    : public command
{
