 ...
 */
#ifndef SX_VALIDSIG_HPP
#define SX_VALIDSIG_HPP
...
/**
 * Class to implement the sx validsig command.
 */
class validsig : public command
{
public:
     ...
     */
    static const char* symbol() { return "validsig"; }
    ...
    const std::vector<char*> example()
    {
        return
        {
            { "sx validsig FILENAME INDEX SCRIPT_CODE SIGNATURE" }
        };
    }
