 ...
 */
#ifndef SX_SHOWSCRIPT_HPP
#define SX_SHOWSCRIPT_HPP
...
/**
 * Class to implement the sx showscript command.
 */
class showscript : public command
{
public:
     ...
     */
    static const char* symbol() { return "showscript"; }
