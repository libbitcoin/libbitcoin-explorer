 ...
 */
#ifndef SX_SCRIPT_TO_ADDR_HPP
#define SX_SCRIPT_TO_ADDR_HPP
...
/**
 * Class to implement the sx script-to-addr command.
 */
class script_to_addr 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "script-to-addr"; }
