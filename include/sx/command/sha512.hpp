 ...
 */
#ifndef SX_SHA512_HPP
#define SX_SHA512_HPP
...
/**
 * Class to implement the sx sha512 command.
 */
class sha512 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "sha512"; }
    ...
    virtual options_metadata& load_options()
    {
        ...
        options.add_options()
            ...
            (
                ...
                "Perform a SHA512 hash of hex encoded data."
            )
            (
                "HEX",
