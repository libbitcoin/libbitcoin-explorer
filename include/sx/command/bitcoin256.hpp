 ...
 */
#ifndef SX_BITCOIN256_HPP
#define SX_BITCOIN256_HPP
...
/**
 * Class to implement the sx bitcoin256 command.
 */
class bitcoin256 
    : public command
{
    ...
    virtual options_metadata& load_options()
    {
        ...
        options.add_options()
            ...
            (
                ...
                "Perform a SHA256 hash of a SHA256 hash of hex encoded data."
            )
            (
                "HEX",
