 ...
 */
#ifndef SX_WIF_TO_SECRET_HPP
#define SX_WIF_TO_SECRET_HPP
...
/**
 * Class to implement the sx wif-to-secret command.
 */
class wif_to_secret : public command
{
public:
     ...
     */
    static const char* symbol() { return "wif-to-secret"; }
