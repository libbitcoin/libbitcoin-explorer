 ...
 */
#ifndef SX_HD_TO_PUBLIC_HPP
#define SX_HD_TO_PUBLIC_HPP
...
/**
 * Class to implement the sx hd-to-public command.
 */
class hd_to_public 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "hd-to-public"; }
    ...
    virtual options_metadata& load_options()
    {
        ...
        options.add_options()
            ...
            (
                "HD_PRIVATE_KEY",
                value<serializer::hd_priv>(&argument_.hd_private_key),
                "The HD private key."
            );
     ...
     */
    virtual serializer::hd_priv& get_hd_private_key_argument()
    {
...
private:
    ...
    struct argument
    {
        ...
        serializer::hd_priv hd_private_key;
    } argument_;
