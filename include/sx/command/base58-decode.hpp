 ...
 */
#ifndef SX_BASE58_DECODE_HPP
#define SX_BASE58_DECODE_HPP
...
/**
 * Class to implement the sx base58-decode command.
 */
class base58_decode 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "base58-decode"; }
    ...
    virtual options_metadata& load_options()
    {
        ...
        options.add_options()
            ...
            (
                ...
                "Convert a Base58 value to a hex encoded data."
            )
            (
                "BASE58",
    ...
    {
        auto base58 = variables.find("BASE58");
        if (base58 == variables.end())
            parse(argument_.base58, read_stream(input));
    }
