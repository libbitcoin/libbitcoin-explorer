 ...
 */
#ifndef SX_SECRET_TO_WIF_HPP
#define SX_SECRET_TO_WIF_HPP
...
/**
 * Class to implement the sx secret-to-wif command.
 */
class secret_to_wif : public command
{
public:
     ...
     */
    static const char* symbol() { return "secret-to-wif"; }
