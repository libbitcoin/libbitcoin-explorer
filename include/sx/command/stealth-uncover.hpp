 ...
 */
#ifndef SX_STEALTH_UNCOVER_HPP
#define SX_STEALTH_UNCOVER_HPP
...
/**
 * Class to implement the sx stealth-uncover command.
 */
class stealth_uncover : public command
{
public:
     ...
     */
    static const char* symbol() { return "stealth-uncover"; }
