 ...
 */
#ifndef SX_ADDRESS_EMBED_HPP
#define SX_ADDRESS_EMBED_HPP
 ...
 */
#define SX_ADDRESS_EMBED_NOT_IMPLEMENTED \
    "This command is not yet implemented."

/**
 * Class to implement the sx address-embed command.
 */
class address_embed 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "address-embed"; }
