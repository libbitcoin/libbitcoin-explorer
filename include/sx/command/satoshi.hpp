 ...
 */
#ifndef SX_SATOSHI_HPP
#define SX_SATOSHI_HPP
 ...
 */
#define SX_SATOSHI_NOT_IMPLEMENTED \
    "This command is not yet ported from python."

/**
 * Class to implement the sx satoshi command.
 */
class satoshi 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "satoshi"; }
    ...
    {
        auto btc = variables.find("BTC");
        if (btc == variables.end())
            parse(argument_.btc, read_stream(input));
    }
     ...
     */
    virtual void set_btc_argument(std::string value)
    {
        argument_.btc = value;
    }
