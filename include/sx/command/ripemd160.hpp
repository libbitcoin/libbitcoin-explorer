 ...
 */
#ifndef SX_RIPEMD160_HPP
#define SX_RIPEMD160_HPP
...
/**
 * Class to implement the sx ripemd160 command.
 */
class ripemd160 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "ripemd160"; }
    ...
    virtual options_metadata& load_options()
    {
        ...
        options.add_options()
            ...
            (
                ...
                "Perform a RIPEMD160 hash of hex encoded data."
            )
            (
                "HEX",
