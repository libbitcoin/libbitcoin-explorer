 ...
 */
#ifndef SX_ADDRESS_DECODE_HPP
#define SX_ADDRESS_DECODE_HPP
...
/**
 * Class to implement the sx address-decode command.
 */
...
public:
     ...
     */
    static const char* symbol() { return "address-decode"; }
