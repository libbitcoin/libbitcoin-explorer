 ...
 */
#ifndef SX_SATOSHI_TO_BTC_HPP
#define SX_SATOSHI_TO_BTC_HPP
 ...
 */
#define SX_SATOSHI_TO_BTC_NOT_IMPLEMENTED \
    "This command is not yet implemented."

/**
 * Class to implement the sx satoshi-to-btc command.
 */
...
public:
     ...
     */
    static const char* symbol() { return "satoshi-to-btc"; }
    ...
    {
        //load_input(get_satoshi_argument(), "SATOSHI", variables, input);
    }
    ...
    virtual options_metadata& load_options()
    {
        ...
        options.add_options()
            ...
            (
                ...
                "The whole number of satoshi to convert."
            );
