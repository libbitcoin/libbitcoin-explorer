 ...
 */
#ifndef SX_SEND_TX_BCI_HPP
#define SX_SEND_TX_BCI_HPP
 ...
 */
#define SX_SEND_TX_BCI_NOT_IMPLEMENTED \
    "This command is not yet implemented."

/**
 * Class to implement the sx send-tx-bci command.
 */
class send_tx_bci 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "send-tx-bci"; }
    ...
    virtual options_metadata& load_options()
    {
        ...
        options.add_options()
            ...
            (
                ...
                "Broadcast a transaction to the Bitcoin transaction pool via blockchain.info."
            )
            (
                "TRANSACTION",
                value<std::string>(),
