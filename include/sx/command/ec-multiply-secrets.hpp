 ...
 */
#ifndef SX_EC_MULTIPLY_SECRETS_HPP
#define SX_EC_MULTIPLY_SECRETS_HPP
...
/**
 * Class to implement the sx ec-multiply-secrets command.
 */
...
public:
     ...
     */
    static const char* symbol() { return "ec-multiply-secrets"; }
    ...
    virtual options_metadata& load_options()
    {
        ...
        options.add_options()
            ...
            (
                "SECRET",
                value<std::vector<serializer::ec_private>>(&argument_.secrets),
                "The set of hex encoded EC secrets to multiply."
            );
    ...
    virtual void set_secrets_argument(
        const std::vector<serializer::ec_private>& value)
    {
