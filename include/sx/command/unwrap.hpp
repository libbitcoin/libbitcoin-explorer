 ...
 */
#ifndef SX_UNWRAP_HPP
#define SX_UNWRAP_HPP
...
/**
 * Class to implement the sx unwrap command.
 */
class unwrap : public command
{
public:
     ...
     */
    static const char* symbol() { return "unwrap"; }
