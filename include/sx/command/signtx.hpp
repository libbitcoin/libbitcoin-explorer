 ...
 */
#ifndef SX_SIGNTX_HPP
#define SX_SIGNTX_HPP
 ...
 */
#define SX_SIGNTX_NOT_IMPLEMENTED \
    "This command is not yet implemented."

/**
 * Class to implement the sx signtx command.
 */
class signtx 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "signtx"; }
