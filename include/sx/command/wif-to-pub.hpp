 ...
 */
#ifndef SX_WIF_TO_PUB_HPP
#define SX_WIF_TO_PUB_HPP
...
/**
 * Class to implement the sx wif-to-pub command.
 */
class wif_to_pub 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "wif-to-pub"; }
