 ...
 */
#ifndef SX_SCRIPT_TO_ADDRESS_HPP
#define SX_SCRIPT_TO_ADDRESS_HPP
...
/**
 * Class to implement the sx script-to-address command.
 */
...
public:
     ...
     */
    static const char* symbol() { return "script-to-address"; }
