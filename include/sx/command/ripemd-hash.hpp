 ...
 */
#ifndef SX_RIPEMD_HASH_HPP
#define SX_RIPEMD_HASH_HPP
...
/**
 * Class to implement the sx ripemd-hash command.
 */
class ripemd_hash : public command
{
public:
     ...
     */
    static const char* symbol() { return "ripemd-hash"; }
