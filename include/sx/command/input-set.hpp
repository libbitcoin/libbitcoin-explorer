 ...
 */
#define SX_INPUT_SET_INDEX_OUT_OF_RANGE \
    "The index does not refer to an existing input."

/**
 * Class to implement the sx input-set command.
 */
class input_set 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "input-set"; }
     ...
     */
    virtual serializer::script& get_signature_and_pubkey_script_argument()
    {
...
private:
    ...
    struct argument
    {
        ...
        serializer::script signature_and_pubkey_script;
    } argument_;
