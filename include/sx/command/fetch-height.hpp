 ...
 */
#ifndef SX_FETCH_HEIGHT_HPP
#define SX_FETCH_HEIGHT_HPP
...
/**
 * Class to implement the sx fetch-height command.
 */
class fetch_height 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "fetch-height"; }
    ...
    virtual options_metadata& load_options()
    {
        ...
        options.add_options()
            ...
            (
                ...
                "Get the last block height. Requires an Obelisk server connection."
            );
