 ...
 */
#ifndef SX_HD_PUBLIC_HPP
#define SX_HD_PUBLIC_HPP
 ...
 */
#define SX_HD_PUBLIC_HARD_OPTION_CONFLICT \
    "The hard option requires a private key."

/**
 * Class to implement the sx hd-public command.
 */
class hd_public 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "hd-public"; }
    ...
    virtual options_metadata& load_options()
    {
        ...
        options.add_options()
            ...
            (
                "HD_PUBLIC_KEY",
                value<serializer::hd_key>(&argument_.hd_public_key),
     ...
     */
    virtual serializer::hd_key& get_hd_public_key_argument()
    {
     ...
     */
    virtual void set_hd_public_key_argument(
...
private:
    ...
    struct argument
    {
        ...
        serializer::hd_key hd_public_key;
    } argument_;
