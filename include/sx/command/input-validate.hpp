 ...
 */
#define SX_INPUT_VALIDATE_INDEX_OUT_OF_RANGE \
    "The index does not refer to an existing input."
#define SX_INPUT_VALIDATE_INDEX_VALID_SIGNATURE \
    "The signature is valid."
#define SX_INPUT_VALIDATE_INDEX_INVALID_SIGNATURE \
    "The signature is not valid."

/**
 * Class to implement the sx input-validate command.
 */
...
public:
     ...
     */
    virtual serializer::script& get_script_code_argument()
    {
