 ...
 */
#ifndef SX_FETCH_CONFIRMED_HPP
#define SX_FETCH_CONFIRMED_HPP
 ...
 */
#define SX_FETCH_CONFIRMED_OUTPUT \
    "  Unconfirmed: %1%"

/**
 * Class to implement the sx fetch-confirmed command.
 */
class fetch_confirmed 
    : public command
{
public:
     ...
     */
    static const char* symbol() { return "fetch-confirmed"; }
