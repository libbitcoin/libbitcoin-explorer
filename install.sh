...
build_all()
{
    ...
    build_from_github pmienk libbitcoin-client refactor_type $PARALLEL "$@" $BITCOIN_CLIENT_OPTIONS
    build_from_travis pmienk libbitcoin-explorer refactor_type $PARALLEL "$@" $BITCOIN_EXPLORER_OPTIONS
}
