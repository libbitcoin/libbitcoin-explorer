...
build_all()
{
    ...
    build_from_github libbitcoin libbitcoin-client network $PARALLEL "$@" $BITCOIN_CLIENT_OPTIONS
    build_from_travis libbitcoin libbitcoin-explorer network $PARALLEL "$@" $BITCOIN_EXPLORER_OPTIONS
}
