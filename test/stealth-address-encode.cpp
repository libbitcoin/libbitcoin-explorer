...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key_two_spend_key__okay_output)
{
    SX_DECLARE_COMMAND(stealth_address_encode);
    command.set_scan_pubkey_argument({ STEALTH_ADDRESS_ENCODE_SCAN_PUBKEY_A });
...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key_two_spend_key_signatures_overflow__failure_error)
{
    SX_DECLARE_COMMAND(stealth_address_encode);
...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key_two_spend_key_1_signature__okay_output)
{
    SX_DECLARE_COMMAND(stealth_address_encode);
...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key_two_spend_key_1_signature_prefix__okay_output)
{
    SX_DECLARE_COMMAND(stealth_address_encode);
    command.set_signatures_option(1);
