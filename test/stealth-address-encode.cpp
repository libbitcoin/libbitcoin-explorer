...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key_signatures_four_mainnet__okay_output)
{
    // $ sx stealth-address-encode -s 4 031bab84e687e36514eeaf5a017c30d32c1f59dd4ea6629da7970ca374513dd006
    SX_DECLARE_COMMAND(stealth_address_encode);
...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key_reuse_key_mainnet__okay_output)
{
    // $ sx stealth-address-encode -r true 031bab84e687e36514eeaf5a017c30d32c1f59dd4ea6629da7970ca374513dd006
    SX_DECLARE_COMMAND(stealth_address_encode);
...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key_reuse_key_signatures_mainnet__okay_output)
{
    // $ sx stealth-address-encode -r true -s 4 031bab84e687e36514eeaf5a017c30d32c1f59dd4ea6629da7970ca374513dd006
    SX_DECLARE_COMMAND(stealth_address_encode);
    command.set_reuse_key_option(true);
    command.set_signatures_option(4);
    command.set_scan_key_argument({ "031bab84e687e36514eeaf5a017c30d32c1f59dd4ea6629da7970ca374513dd006" });
...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key_signatures_four_testnet__okay_output)
{
    // $ sx stealth-address-encode -s 4 031bab84e687e36514eeaf5a017c30d32c1f59dd4ea6629da7970ca374513dd006
    SX_DECLARE_COMMAND(stealth_address_encode);
    command.set_general_testnet_setting(true);
...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key_reuse_key_testnet__okay_output)
{
    // $ sx stealth-address-encode -r true 031bab84e687e36514eeaf5a017c30d32c1f59dd4ea6629da7970ca374513dd006
    SX_DECLARE_COMMAND(stealth_address_encode);
    command.set_general_testnet_setting(true);
...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key_reuse_key_signatures_testnet__okay_output)
{
    // $ sx stealth-address-encode -r true -s 4 031bab84e687e36514eeaf5a017c30d32c1f59dd4ea6629da7970ca374513dd006
    SX_DECLARE_COMMAND(stealth_address_encode);
    command.set_general_testnet_setting(true);
