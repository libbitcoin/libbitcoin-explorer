...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector1_public_m_0h__failure_error)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector1_public_m_0h_1__okay_output)
{
    // $ sx embed-addr xpub68Gmy5EdvgibQVfPdqkBBCHxA5htiqg55crXYuXoQRKfDBFA1WEjWgP6LHhwBZeNK1VTsfTFUHCdrfp1bgwQ9xv5ski8PX9rL2dZXvgGDnw 1
    SX_DECLARE_COMMAND(hd_pub);
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector1_public_m_0h_1_2h__failure_error)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector1_public_m_0h_1_2h_2__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector1_public_m_0h_1_2h_2_1000000000__okay_output)
{
    ...
    SX_DECLARE_COMMAND(hd_pub);
    command.set_hard_option(false);
    command.set_index_argument(1000000000);
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector1_private_m_0h__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector1_private_m_0h_1__okay_output)
{
    // $ sx embed-addr xprv9uHRZZhk6KAJC1avXpDAp4MDc3sQKNxDiPvvkX8Br5ngLNv1TxvUxt4cV1rGL5hj6KCesnDYUhd7oWgT11eZG7XnxHrnYeSvkzY7d2bhkJ7 1
    SX_DECLARE_COMMAND(hd_pub);
    command.set_hard_option(false);
    command.set_index_argument(1);
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector1_private_m_0h_1_2h__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector1_private_m_0h_1_2h_2__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector1_private_m_0h_1_2h_2_1000000000__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector2_public_m_0__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector2_public_m_0_2147483647h__failure_error)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector2_public_m_0_2147483647h_1__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector2_public_m_0_2147483647h_1_2147483646h__failure_error)
{
    ...
    SX_DECLARE_COMMAND(hd_pub);
    command.set_hard_option(true);
    command.set_index_argument(2147483646);
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector2_public_m_0_2147483647h_1_2147483646h_2__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector2_private_m_0__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector2_private_m_0_2147483647h__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector2_private_m_0_2147483647h_1__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector2_private_m_0_2147483647h_1_2147483646h__okay_output)
{
...
BOOST_AUTO_TEST_CASE(hd_pub__invoke__vector2_private_m_0_2147483647h_1_2147483646h_2__okay_output)
{
