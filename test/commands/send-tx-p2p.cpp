...
BOOST_AUTO_TEST_CASE(send_tx_p2p__invoke__nodes_2_tx_A__okay)
{
    BX_DECLARE_COMMAND(send_tx_p2p);
    command.set_nodes_option(2);
    command.set_transactions_argument({ { SEND_TX_P2P_A } });

    // This throws an access violation.
