...
BOOST_AUTO_TEST_CASE(electrum_new__invoke__okay_output)
{
...
BOOST_AUTO_TEST_CASE(electrum_new__invoke__dictionary_prefix_okay_output)
{
    BX_DECLARE_COMMAND(electrum_new);
    command.set_seed_argument({ "05e669b4270f4e25bce6fc3736170d423c" });
...
BOOST_AUTO_TEST_CASE(electrum_new__invoke__large_entropy_okay_output)
{
    BX_DECLARE_COMMAND(electrum_new);
