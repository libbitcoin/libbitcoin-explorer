...
#define STEALTH_ADDRESS_ENCODE_MAX_PREFIX_LENGTH "11111111110000000000111111111100"

// expectations
#define STEALTH_ADDRESS_ENCODE_ADDRESS_A "hfFGUXFPKkQ5M6LC6aEUKMsURdhw93bUdYdacEtBA8XttLv7evZkira2i"
#define STEALTH_ADDRESS_ENCODE_ADDRESS_AM "5b4Xkx9DVQj5nznykpKLeoNWHes1ZHJh3aCvxNNXUTuErKTyYq8NKX3xNb3Q7xg"
...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key__okay_output)
{
    ...
    BX_REQUIRE_OUTPUT(STEALTH_ADDRESS_ENCODE_ADDRESS_A "\n");
}
...
BOOST_AUTO_TEST_CASE(stealth_address_encode__invoke__scan_key_spend_key__okay_output)
{
    ...
    BX_REQUIRE_OKAY(command.invoke(output, error));
    BX_REQUIRE_OUTPUT(STEALTH_ADDRESS_ENCODE_ADDRESS_AB "\n");
}
