...
#define BX_FETCH_TX_INDEX_SATOSHIS_WORDS_INDEX "[4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b] Height: 0 Index: 0"

#define BX_FETCH_TX_SECOND_TX_HASH "0e3e2357e806b6cdb1f70b54c3a3a17b6714ee1f0e68bebb44a74b1efd512098"
#define BX_FETCH_TX_INDEX_SECOND_INDEX "[0e3e2357e806b6cdb1f70b54c3a3a17b6714ee1f0e68bebb44a74b1efd512098] Height: 1 Index: 0"
...
BOOST_AUTO_TEST_CASE(fetch_tx_index__invoke__mainnet_satoshis_words_tx_native__okay_output)
{
    ...
    command.set_format_option({ "native" }); // OTHERS NOT IMPLEMENTED
    ...
    BX_REQUIRE_OUTPUT(BX_FETCH_TX_INDEX_SATOSHIS_WORDS_INDEX "\n");
}
...
BOOST_AUTO_TEST_CASE(fetch_tx_index__invoke__mainnet_second_tx_native__okay_output)
{
    ...
    command.set_server_address_setting(BX_MAINNET_SERVER);
    BX_REQUIRE_OKAY(command.invoke(output, error));
    BX_REQUIRE_OUTPUT(BX_FETCH_TX_INDEX_SECOND_INDEX "\n");
}
