...
"    mainnet\n" \
"    {\n" \
"        certificate_file mainnet.certificate.zpl\n" \
"        server_key \"CrWu}il)+MbqD60BV)v/xt&Xtwj*$[Q}Q{$9}hom\"\n" \
"        url https://mainnet.obelisk.net:42\n" \
"    }\n" \
"    testnet\n" \
"    {\n" \
"        certificate_file testnet.certificate.zpl\n" \
"        server_key \"DrWu}il)+MbqD60BV)v/xt&Xtwj*$[Q}Q{$9}hom\"\n" \
...
BOOST_AUTO_TEST_CASE(settings__invoke__test_values__okay_output)
{
    ...
    command.set_mainnet_certificate_file_setting("mainnet.certificate.zpl");
    command.set_mainnet_server_key_setting({ "CrWu}il)+MbqD60BV)v/xt&Xtwj*$[Q}Q{$9}hom" });
    command.set_testnet_url_setting({ "https://testnet.obelisk.net:42" });
    command.set_testnet_certificate_file_setting("testnet.certificate.zpl");
    command.set_testnet_server_key_setting({ "DrWu}il)+MbqD60BV)v/xt&Xtwj*$[Q}Q{$9}hom" });
