...
BOOST_AUTO_TEST_SUITE(match_basic_filter_address__invoke)

BOOST_AUTO_TEST_CASE(match_basic_filter_address__invoke__match)
{
    BX_DECLARE_COMMAND(match_basic_filter_address);
    ...
    BX_REQUIRE_OUTPUT("Address matched filter.\n");
}

BOOST_AUTO_TEST_CASE(match_basic_filter_address__invoke__no_match)
{
    BX_DECLARE_COMMAND(match_basic_filter_address);
    const std::string filter(
        "006a368420a2ea3451d21bd68edc9e6176ccfdc785a707"
...
BOOST_AUTO_TEST_CASE(match_basic_filter_address__invoke__invalid_filter_type)
{
    BX_DECLARE_COMMAND(match_basic_filter_address);
    const std::string filter(
