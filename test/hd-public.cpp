...
{
    // $ sx hd-public xpub661MyMwAqRbcFtXgS5sYJABqqG9YLmC4Q1Rdap9gSE8NqtwybGhePY2gZ29ESFjqJoCu1Rupje8YtGqsefD265TMg7usUDFdp6W1EGMcet8 0 --hard
    SX_DECLARE_COMMAND(hd_public);
    ...
    SX_REQUIRE_ERROR(SX_HD_PUBLIC_HARD_OPTION_CONFLICT "\n");
}

BOOST_AUTO_TEST_CASE(hd_public__invoke__mainnet_vector1_public_m_0h_1__okay_output)
{
    // $ sx hd-public xpub68Gmy5EdvgibQVfPdqkBBCHxA5htiqg55crXYuXoQRKfDBFA1WEjWgP6LHhwBZeNK1VTsfTFUHCdrfp1bgwQ9xv5ski8PX9rL2dZXvgGDnw 1
    SX_DECLARE_COMMAND(hd_public);
...
{
    // $ sx hd-public xpub6ASuArnXKPbfEwhqN6e3mwBcDTgzisQN1wXN9BJcM47sSikHjJf3UFHKkNAWbWMiGj7Wf5uMash7SyYq527Hqck2AxYysAA7xmALppuCkwQ 2 --hard
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(true);
...
{
    // $ sx hd-public xpub6D4BDPcP2GT577Vvch3R8wDkScZWzQzMMUm3PWbmWvVJrZwQY4VUNgqFJPMM3No2dFDFGTsxxpG5uJh7n7epu4trkrX7x7DogT5Uv6fcLW5 2
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(false);
    command.set_index_option(2);
...
{
    // $ sx hd-public xpub6FHa3pjLCk84BayeJxFW2SP4XRrFd1JYnxeLeU8EqN3vDfZmbqBqaGJAyiLjTAwm6ZLRQUMv1ZACTj37sR62cfN7fe5JnJ7dh8zL4fiyLHV 2
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(false);
...
{
    // $ sx hd-public xprv9s21ZrQH143K3QTDL4LXw2F7HEK3wJUD2nW2nRk4stbPy6cq3jPPqjiChkVvvNKmPGJxWUtg6LnF5kejMRNNU3TGtRBeJgk33yuGBxrMPHi 0 --hard
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(true);
    command.set_index_option(0);
...
{
    // $ sx hd-public xprv9uHRZZhk6KAJC1avXpDAp4MDc3sQKNxDiPvvkX8Br5ngLNv1TxvUxt4cV1rGL5hj6KCesnDYUhd7oWgT11eZG7XnxHrnYeSvkzY7d2bhkJ7 1
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(false);
    command.set_index_option(1);
...
{
    // $ sx hd-public xprv9wTYmMFdV23N2TdNG573QoEsfRrWKQgWeibmLntzniatZvR9BmLnvSxqu53Kw1UmYPxLgboyZQaXwTCg8MSY3H2EU4pWcQDnRnrVA1xe8fs 2 --hard
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(true);
    command.set_index_option(2);
...
{
    // $ sx hd-public xprv9z4pot5VBttmtdRTWfWQmoH1taj2axGVzFqSb8C9xaxKymcFzXBDptWmT7FwuEzG3ryjH4ktypQSAewRiNMjANTtpgP4mLTj34bhnZX7UiM 2
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(false);
    command.set_index_option(2);
...
{
    // $ sx hd-public xprvA2JDeKCSNNZky6uBCviVfJSKyQ1mDYahRjijr5idH2WwLsEd4Hsb2Tyh8RfQMuPh7f7RtyzTtdrbdqqsunu5Mm3wDvUAKRHSC34sJ7in334 2
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(false);
    command.set_index_option(1000000000);
...
{
    // $ sx hd-public xpub661MyMwAqRbcFW31YEwpkMuc5THy2PSt5bDMsktWQcFF8syAmRUapSCGu8ED9W6oDMSgv6Zz8idoc4a6mr8BDzTJY47LJhkJ8UB7WEGuduB 0
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(false);
    command.set_index_option(0);
...
{
    // $ sx hd-public xpub69H7F5d8KSRgmmdJg2KhpAK8SR3DjMwAdkxj3ZuxV27CprR9LgpeyGmXUbC6wb7ERfvrnKZjXoUmmDznezpbZb7ap6r1D3tgFxHmwMkQTPH 2147483647 --hard
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(true);
...
{
    // $ sx hd-public xpub6ASAVgeehLbnwdqV6UKMHVzgqAG8Gr6riv3Fxxpj8ksbH9ebxaEyBLZ85ySDhKiLDBrQSARLq1uNRts8RuJiHjaDMBU4Zn9h8LZNnBC5y4a 1
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(false);
    command.set_index_option(1);
...
{
    // $ sx hd-public xpub6DF8uhdarytz3FWdA8TvFSvvAh8dP3283MY7p2V4SeE2wyWmG5mg5EwVvmdMVCQcoNJxGoWaU9DCWh89LojfZ537wTfunKau47EL2dhHKon 2147483646 --hard
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(true);
...
{
    // $ sx hd-public xpub6ERApfZwUNrhLCkDtcHTcxd75RbzS1ed54G1LkBUHQVHQKqhMkhgbmJbZRkrgZw4koxb5JaHWkY4ALHY2grBGRjaDMzQLcgJvLJuZZvRcEL 2
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(false);
    command.set_index_option(2);
...
{
    // $ sx hd-public xprv9s21ZrQH143K31xYSDQpPDxsXRTUcvj2iNHm5NUtrGiGG5e2DtALGdso3pGz6ssrdK4PFmM8NSpSBHNqPqm55Qn3LqFtT2emdEXVYsCzC2U 0
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(false);
    command.set_index_option(0);
...
{
    // $ sx hd-public xprv9vHkqa6EV4sPZHYqZznhT2NPtPCjKuDKGY38FBWLvgaDx45zo9WQRUT3dKYnjwih2yJD9mkrocEZXo1ex8G81dwSM1fwqWpWkeS3v86pgKt 2147483647 --hard
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(true);
    command.set_index_option(2147483647);
...
{
    // $ sx hd-public xprv9wSp6B7kry3Vj9m1zSnLvN3xH8RdsPP1Mh7fAaR7aRLcQMKTR2vidYEeEg2mUCTAwCd6vnxVrcjfy2kRgVsFawNzmjuHc2YmYRmagcEPdU9 1
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(false);
    command.set_index_option(1);
...
{
    // $ sx hd-public xprv9zFnWC6h2cLgpmSA46vutJzBcfJ8yaJGg8cX1e5StJh45BBciYTRXSd25UEPVuesF9yog62tGAQtHjXajPPdbRCHuWS6T8XA2ECKADdw4Ef 2147483646 --hard
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(true);
    command.set_index_option(2147483646);
...
{
    // $ sx hd-public xprvA1RpRA33e1JQ7ifknakTFpgNXPmW2YvmhqLQYMmrj4xJXXWYpDPS3xz7iAxn8L39njGVyuoseXzU6rcxFLJ8HFsTjSyQbLYnMpCqE2VbFWc 2
    SX_DECLARE_COMMAND(hd_public);
    command.set_hard_option(false);
    command.set_index_option(2);
