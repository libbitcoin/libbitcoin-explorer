...
BOOST_AUTO_TEST_CASE(ec_multiply_secrets__invoke__bogus_secret__throws_invalid_option_value)
{
    ...
    SX_REQUIRE_INVALID_OPTION_VALUE(command.set_secrets_argument(
    {
